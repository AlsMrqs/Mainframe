...
coordinate :: Coordinate a => a -> Point
coordinate = \k -> (,,) (coord X k) (coord Y k) (coord Z k)

flatLine :: Point -> Double -> Double -> [Point] -- 2D :: (X,Y)
...
overlap :: Coordinate a => Axis -> a -> [Point] -> Bool -- ?? :: _
overlap axis p ps = 
